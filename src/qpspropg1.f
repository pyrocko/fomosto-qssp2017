...
c
          icruku=icruku+1
          call ruku(yupc,4,2,ly,ldeg,qpdifmatl,rr1,rr2,nstep(icruku))
        enddo
        if(ly.eq.lyr-1)then
          do j=1,3
            do i=1,6
...
c
          icruku=icruku+1
          call ruku(yup,6,3,ly,ldeg,qpdifmats,rr1,rr2,nstep(icruku))
        enddo
...
c
          icruku=icruku+1
          call ruku(ylw,6,3,ly,ldeg,qpdifmats,rr1,rr2,nstep(icruku))
        enddo
...
c
          icruku=icruku+1
          call ruku(ylwc,4,2,ly,ldeg,qpdifmatl,rr1,rr2,nstep(icruku))
        enddo
