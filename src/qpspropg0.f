...
c     work space
c
      integer*4 i,istp,ly,lyswap,ily,nly,ldeg,key
...
c
      do ly=lyup,lys-1
        ...
        do ily=1,nly
          ...
          icruku=icruku+1
          call ruku(yup,3,1,ly,ldeg,qpdifmat0,rr1,rr2,nstep(icruku))
        enddo
...
c
      do ly=lylw-1,lys,-1
        ...
        do ily=1,nly
          ...
          icruku=icruku+1
          call ruku(ylw,3,1,ly,ldeg,qpdifmat0,rr1,rr2,nstep(icruku))
        enddo
